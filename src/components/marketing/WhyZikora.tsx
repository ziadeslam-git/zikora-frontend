 ...
 * Dual-theme compliant: 1 highlighted card with bg-brand-gradient and white text,
 * 5 feature cards with bg-bg-surface and border-border-theme.
 */
  ...
  return (
    <section className="py-20 lg:py-28 max-w-[1280px] mx-auto px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Card 1 — Highlighted (Gradient, 2 rows desktop) */}
        <div className="md:col-span-1 md:row-span-2 bg-brand-gradient text-white rounded-2xl p-6 lg:p-8 shadow-lg flex flex-col justify-between relative overflow-hidden group">
          ...
          <div className="mt-8 pt-6 border-t border-white/20 relative z-10 text-start">
        ...
        {/* Card 2: تقرير واتساب */}
        <div className="bg-bg-surface border border-border-theme rounded-2xl p-6 lg:p-8 hover:shadow-md transition-shadow text-start">
        ...
        {/* Card 6: داشبورد تقدم */}
        <div className="bg-bg-surface border border-border-theme rounded-2xl p-6 lg:p-8 hover:shadow-md transition-shadow md:col-span-2 lg:col-span-1 text-start">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-accent-blob/40 text-accent-500 shrink-0">
